...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $redirect = '/crims/dosen/achievements.php';
        ...
        <div class="card">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Deskripsi singkat tentang prestasi..."><?= $formData['description'] ?? '' ?></textarea>
                    ...
                    <tbody>
                        <?php foreach ($achievements as $achievement): ?>
                            <tr>
                                ...
                                <td><?= !empty($achievement['role']) ? ucfirst($achievement['role']) : ucfirst($_SESSION['role'] ?? 'dosen') ?></td>
...
renderDosenLayout($activePage, 'Kelola Prestasi', $content);
?>

...
// Get statistics - hanya data yang dibuat oleh dosen ini
...
// Get latest activity - hanya yang dibuat oleh dosen ini
$latestNews = [];
...
<style>
    .dashboard-welcome {
        ...
        margin-bottom: 32px;
        color: #fff;
        box-shadow: 0 8px 24px rgba(16, 185, 129, 0.25), 0 4px 8px rgba(16, 185, 129, 0.15);
        position: relative;
        overflow: hidden;
    }
    ...
    <div class="dashboard-section">
        ...
        <ul class="dashboard-list">
            <?php foreach ($latestNews as $news): ?>
                <li>
                    <a href="/crims/dosen/news.php"><?= htmlspecialchars($news['title']) ?></a>
    ...
    <div class="dashboard-section">
        ...
        <ul class="dashboard-list">
            <?php foreach ($latestProjects as $project): ?>
                <li>
                    <a href="/crims/dosen/projects.php"><?= htmlspecialchars($project['title']) ?></a>
...
renderDosenLayout($activePage, 'Dashboard', $content);
?>

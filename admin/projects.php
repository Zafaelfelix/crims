    ...
    try {
        if ($action === 'delete') {
            ...
            if ($id > 0) {
                ...
                $stmt = $mysqli->prepare('INSERT INTO project_items (title, category, summary, image_url, detail_url, is_featured, sort_order) VALUES (?, ?, ?, ?, NULL, ?, ?)');
                $stmt->bind_param('ssssii', $title, $category, $summary, $imagePath, $isFeatured, $sortOrder);
                $stmt->execute();
                $stmt->close();
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div style="display:flex;gap:12px">
                    ...
                    <?php if ($editingProject): ?>
                        <a href="/crims/admin/projects.php" class="btn secondary">Batal</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>

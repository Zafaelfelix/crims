<?php
if (!function_exists('renderMahasiswaLayout')) {
    function renderMahasiswaLayout($activePage = 'dashboard', $pageTitle = 'Mahasiswa Panel', $content = '') {
        // Warna tema mahasiswa: Orange (#f59e0b, #d97706)
        $primaryColor = '#f59e0b';
        $primaryDark = '#d97706';
        $primaryLight = '#fbbf24';
        ?>
...
<head>
    ...
    <style>
        * {
        ...
        /* Sidebar - Mahasiswa Theme (Orange) */
        .admin-sidebar {
            width: 200px;
        ...
        .admin-sidebar-logo {
            ...
            flex-shrink: 0;
            box-shadow: 0 4px 12px rgba(245, 158, 11, 0.4), 0 2px 4px rgba(245, 158, 11, 0.3), inset 0 1px 0 rgba(255,255,255,.3);
            position: relative;
            overflow: hidden;
        }
        ...
        .admin-sidebar-menu a.active {
            ...
            color: #fff;
            box-shadow: -2px 0 12px rgba(245, 158, 11, 0.3), inset 0 0 20px rgba(245, 158, 11, 0.1);
        }
        ...
        .admin-topbar a.topbar-link-view {
            background: linear-gradient(135deg, <?= $primaryColor ?> 0%, <?= $primaryDark ?> 100%);
            color: #ffffff;
            box-shadow: 0 3px 10px rgba(245, 158, 11, 0.3), 0 1px 3px rgba(245, 158, 11, 0.2), inset 0 1px 0 rgba(255,255,255,.2);
        }
        
        .admin-topbar a.topbar-link-view:hover {
            background: linear-gradient(135deg, <?= $primaryDark ?> 0%, #b45309 100%);
            color: #fff;
            transform: translateY(-3px);
            box-shadow: 0 6px 20px rgba(245, 158, 11, 0.4), 0 3px 8px rgba(245, 158, 11, 0.3), inset 0 1px 0 rgba(255,255,255,.2);
        }
        ...
        .btn {
            ...
            align-items: center;
            gap: 10px;
            box-shadow: 0 4px 12px rgba(245, 158, 11, 0.3), 0 2px 4px rgba(245, 158, 11, 0.2), inset 0 1px 0 rgba(255,255,255,.2);
            font-family: 'Poppins', 'Plus Jakarta Sans', sans-serif;
            letter-spacing: 0.2px;
        }
        ...
        .btn:hover {
            background: linear-gradient(135deg, <?= $primaryDark ?> 0%, #b45309 100%);
            box-shadow: 0 6px 20px rgba(245, 158, 11, 0.4), 0 4px 8px rgba(245, 158, 11, 0.3), inset 0 1px 0 rgba(255,255,255,.2);
            transform: translateY(-3px);
        }
    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <nav class="admin-sidebar-menu">
                <a href="/crims/mahasiswa/dashboard.php" <?= $activePage === 'dashboard' ? 'class="active"' : '' ?>>
                    <i class="fas fa-tachometer-alt"></i>
                    <span>Dashboard</span>
                </a>
                <a href="/crims/mahasiswa/achievements.php" <?= $activePage === 'achievements' ? 'class="active"' : '' ?>>
                    <i class="fas fa-trophy"></i>
                    <span>Prestasi</span>
                </a>
                <a href="/crims/mahasiswa/news.php" <?= $activePage === 'news' ? 'class="active"' : '' ?>>
                    <i class="fas fa-newspaper"></i>
                    <span>Berita</span>
                </a>
                <a href="/crims/mahasiswa/projects.php" <?= $activePage === 'projects' ? 'class="active"' : '' ?>>
